...
router.get(
  "/newAddressEdit",
  userCheck.isUser,
  profileController.newAddressEdit
);
router.post(
  "/newAddressEdit",
  userCheck.isUser,
  profileController.newEditAddress
);
...
router.post(
  "/displayaddress",
  userCheck.isUser,
  orderController.displayaddress
);
...
router.post(
  "/returnreason/:id",
  userCheck.isUser,
  orderController.returnreason
);
router.get(
  "/orderHistoryPage/:id",
  userCheck.isUser,
  orderController.showDetailOrderHistory
);
